...
public class ChunkProviderMadLands implements IChunkProvider{
    ...
    public ChunkProviderMadLands(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    blocks[j3 += short1] = Blocks.glowstone;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
    ...
    public void replaceBlocksForBiome(int chunkX, int chunkZ, Block[] blocks, byte[] byteArray, BiomeGenBase[] biomes)
    {
        ChunkProviderEvent.ReplaceBiomeBlocks event = new ChunkProviderEvent.ReplaceBiomeBlocks(this, chunkX, chunkZ, blocks, byteArray, biomes, this.worldObj);
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                biomegenbase.genTerrainBlocks(this.worldObj, this.rand, blocks, byteArray, chunkX * 16 + k, chunkZ * 16 + l, this.stoneNoise[l + k * 16]);
